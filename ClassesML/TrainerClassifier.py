...
class TrainerClassifier:
    ...
    def run(self):
        ...
        for epoch in range(self.hyperparameter["max_epochs"]):
            ...
            print(
                "epoch:" + str(epoch + 1) + "/" + str(self.hyperparameter["max_epochs"])
            )
            ...
            if self.scope.early_stopper:
                validation_metric = valid_accuracy
                self.model, keeptraining = self.scope.early_stopper.set(
            ...
            train_accuracy_list = [
                train_accuracy_dict[e] for e in train_accuracy_dict.keys()
            ]
            valid_accuracy_list = [
                valid_accuracy_dict[e] for e in valid_accuracy_dict.keys()
            ]
